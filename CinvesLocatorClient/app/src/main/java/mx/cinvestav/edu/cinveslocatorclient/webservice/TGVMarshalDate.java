...
public class TGVMarshalDate implements Marshal
{
    ...
    {
        return TGVHelper.ConvertFromWebService(parser.nextText());
    }
    ...
    {
        writer.text(TGVHelper.getDateFormat().format((Date)obj));
    }
}
