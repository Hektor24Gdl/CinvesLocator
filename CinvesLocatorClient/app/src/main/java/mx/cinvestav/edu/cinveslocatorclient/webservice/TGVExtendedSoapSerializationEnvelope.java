...
public class TGVExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    static HashMap< java.lang.String,java.lang.Class> classNames = new HashMap< java.lang.String, java.lang.Class>();
    static {
        classNames.put("http://webservice.locator.cinvestav.com/^^LocatorException",TGVLocatorException.class);
        classNames.put("http://webservice.locator.cinvestav.com/^^agent",TGVagent.class);
        classNames.put("http://webservice.locator.cinvestav.com/^^type",TGVtype.class);
        classNames.put("http://webservice.locator.cinvestav.com/^^location",TGVlocation.class);
        classNames.put("http://webservice.locator.cinvestav.com/^^getTypeAgentResponse",TGVgetTypeAgentResponse.class);
    }   

    protected static final int QNAME_NAMESPACE = 0;
    private static final String TYPE_LABEL = "type";

    public TGVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TGVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TGVMarshalGuid().register(this);
        new TGVMarshalDate().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            ...
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=String.class)) {
                java.lang.String xmlName=TGVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public java.lang.Object get(java.lang.Object soap,java.lang.Class cl)
    {
        ...
        try
        {
            ...
            {
                Constructor ctor = cl.getConstructor(java.lang.Object.class,TGVExtendedSoapSerializationEnvelope.class);
